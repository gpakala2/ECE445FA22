...
module fast_accel_xfMat2Array_8_0_1080_1440_1_1_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    dstPtr_blk_n;
reg   [63:0] dstPtr_read_reg_85;
wire   [15:0] trunc_ln1558_fu_75_p1;
reg   [15:0] trunc_ln1558_reg_90;
...
fast_accel_Mat2Axi grp_Mat2Axi_fu_62(
    ...
    .dout(dstPtr_read_reg_85),
    .rows(trunc_ln1558_reg_90),
    .cols(p_read1),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .dout_ap_vld(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state2) & (ap_sync_grp_Mat2Axi_fu_62_ap_ready == 1'b0)) | (~((dstPtr_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        dstPtr_read_reg_85 <= dstPtr_dout;
        trunc_ln1558_reg_90 <= trunc_ln1558_fu_75_p1;
    end
end
...
assign trunc_ln1558_fu_75_p1 = p_read[15:0];

endmodule //fast_accel_xfMat2Array_8_0_1080_1440_1_1_1_s
