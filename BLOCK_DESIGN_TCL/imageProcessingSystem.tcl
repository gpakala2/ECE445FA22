...
user.org:user:imageProcessTop:1.0\
...
proc create_root_design { parentCell } {
  ...
  set imageProcessTop_0 [ create_bd_cell -type ip -vlnv user.org:user:imageProcessTop:1.0 imageProcessTop_0 ]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_intf_net -intf_net imageProcessTop_0_m_axis [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins imageProcessTop_0/m_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets imageProcessTop_0_m_axis] [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets imageProcessTop_0_m_axis]
